...
const GITHUB_REPO = 'embedd-peripheral-viewer';
const VSIX_PREFIX = 'embedd-peripheral-viewer-';
const EXTENSION_ID = 'embedd-team.embedd-peripheral-viewer';
const EXTENSION_DISPLAY_NAME = 'Embedd Peripheral Viewer';
const CONFIG_SECTION = 'mcu-debug.peripheral-viewer';
